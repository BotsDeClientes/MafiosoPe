 ...
 *┃➤* _${usedPrefix}Proveedor / Deseas Vender Mafiosoi ?_
 *┃➤* _${usedPrefix}PinguiComu / Publicidad De La Comunidad Mafiosoi_
 ...
 *┃➤* _${usedPrefix}minarMafiosoicoins | minarcoins_
 ...
 *┃➤* _${usedPrefix}añadircoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝐁𝐨𝐭 𝐌𝐚𝐟𝐢𝐨𝐬𝐨 👹', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
